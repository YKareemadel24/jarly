...
const makeStyles = (c: ThemeColorPalette) => StyleSheet.create({
  ...
  greeting: { color: c.foreground, fontFamily: "Georgia", fontSize: 29, lineHeight: 34, marginTop: 8 },
  ...
  balanceValue: { color: "#FFFDF9", fontSize: 37, lineHeight: 46, marginTop: 8, fontFamily: "Georgia", fontWeight: "700", fontVariant: ["tabular-nums"] },
